 ...
 */
class ThemeHouse_ConvSearch_Extend_XenForo_DataWriter_ConversationMaster extends XFCP_ThemeHouse_ConvSearch_Extend_XenForo_DataWriter_ConversationMaster
{
    ...
    protected function _postSave()
    {
        if ($this->_firstMessageDw) {
            $this->_firstMessageDw->setOption(
                ThemeHouse_ConvSearch_Extend_XenForo_DataWriter_ConversationMessage::OPTION_INDEX_FOR_SEARCH, false);
        }
    ...
    {
        $dataHandler = new ThemeHouse_ConvSearch_Search_DataHandler_Conversation();
