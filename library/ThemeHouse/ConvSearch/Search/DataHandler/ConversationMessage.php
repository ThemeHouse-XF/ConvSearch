 ...
 */
class ThemeHouse_ConvSearch_Search_DataHandler_ConversationMessage extends XenForo_Search_DataHandler_Abstract
{
    ...
    public function rebuildIndex(XenForo_Search_Indexer $indexer, $lastId, $batchSize)
    {
        ...
        if (!class_exists('XFCP_ThemeHouse_ConvSearch_Extend_XenForo_Model_Conversation', false)) {
            return false;
        }
        ...
        array $viewParams)
    {
        ...
        return $controller->responseView('ThemeHouse_ConvSearch_ViewPublic_Search_Form_ConversationMessage',
